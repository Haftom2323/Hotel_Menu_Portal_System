...
class TasksComponent extends React.Component {
    ...
    state = { items: [
        {title: 'Resolve spam report', checked: false, tag: TAGS.URGENT },
        {title: 'check outdated jobs', checked: false, tag: TAGS.NEW },
        {title: 'Update job status', checked: true, tag: TAGS.DEFAULT }
    ]};

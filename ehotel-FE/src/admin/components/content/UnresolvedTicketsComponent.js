...
class UnresolvedTicketsComponent extends React.Component {
    ...
    render() {
        return (
            <CardComponent containerStyles={this.props.containerStyles} title="Unresolved spams"
                link="View details" subtitle="" subtitleTwo=""
                items={[
                    this.renderStat('Waiting on Feature Request', 4238),
                    this.renderStat('Awaiting Company Response', 1005),
